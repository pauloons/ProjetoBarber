...
public class Cadastro extends javax.swing.JFrame {
    ...
    //pegou o texto do controller 
     controller.retornaMensagem();//retorou a mensagem da função criada no controller
     controller.mudarTela();
        System.out.println(txtCpf.getText());//pegou o texto direto da veiw
    ...
    public void retornaMensagem(String mensagem) {
